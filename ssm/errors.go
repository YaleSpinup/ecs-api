...
func ErrCode(msg string, err error) error {
	if aerr, ok := errors.Cause(err).(awserr.Error); ok {
		...
		case
			...
			ssm.ErrCodeInternalServerError:
		...
		case
			...
			ssm.ErrCodeDuplicateDocumentContent,
			...
			// for a patch group.
			ssm.ErrCodeResourceInUseException,
			...
			ssm.ErrCodeTargetInUseException:
		...
		case
			...
			// it.
			ssm.ErrCodeAssociatedInstances,
			...
			ssm.ErrCodeFeatureNotAvailableException,
			...
			ssm.ErrCodeHierarchyTypeMismatchException,
			...
			ssm.ErrCodeIdempotentParameterMismatch,
			...
			ssm.ErrCodeIncompatiblePolicyException,
			...
			ssm.ErrCodeInvalidActivationId,
			...
			ssm.ErrCodeInvalidAssociationVersion,
			...
			ssm.ErrCodeInvalidDeleteInventoryParametersException,
			...
			ssm.ErrCodeInvalidNotificationConfig,
			...
			ssm.ErrCodeInvalidPolicyTypeException,
			...
			// in the AWS Systems Manager User Guide.
			ssm.ErrCodeUnsupportedFeatureRequiredException,
			...
			ssm.ErrCodeUnsupportedInventoryItemContextException,
			...
			// for each type.
			ssm.ErrCodeUnsupportedInventorySchemaVersionException,
			...
			ssm.ErrCodeUnsupportedPlatformType:
		...
		case
			...
			// execution ID.
			ssm.ErrCodeAutomationExecutionNotFoundException,
			...
			// and try again.
			ssm.ErrCodeAutomationStepNotFoundException,
			...
			ssm.ErrCodeDoesNotExistException:
		...
		case
			...
			// limit.
			ssm.ErrCodeAutomationExecutionLimitExceededException,
			...
			ssm.ErrCodeComplianceTypeCountLimitExceededException,
			...
			ssm.ErrCodeCustomSchemaCountLimitExceededException,

			// ErrCodeDocumentLimitExceeded for service response error code
			// "DocumentLimitExceeded".
			//
			// You can have at most 500 active Systems Manager documents.
			ssm.ErrCodeDocumentLimitExceeded,
			...
			ssm.ErrCodeDocumentPermissionLimit,
			...
			// and try again.
			ssm.ErrCodeDocumentVersionLimitExceeded,
			...
			ssm.ErrCodeOpsItemLimitExceededException,
			...
			ssm.ErrCodeParameterVersionLabelLimitExceeded,
			...
			ssm.ErrCodeAssociationVersionLimitExceeded,
